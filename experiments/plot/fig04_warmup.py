...
def main():
    ...
    ax.axvspan(0,a,color=ps.OKABE_ITO[1],alpha=0.10); ax.axvspan(a,g,color=ps.OKABE_ITO[2],alpha=0.10); ax.axvspan(g,60,color=ps.OKABE_ITO[3],alpha=0.10)
    ...
    ax.annotate("SYNC:LOCKED? = 1",xy=(g,40),xytext=(g-13,33),fontsize=7,color=ps.C_ALT,arrowprops=dict(arrowstyle="->",color=ps.C_ALT,lw=0.7))
